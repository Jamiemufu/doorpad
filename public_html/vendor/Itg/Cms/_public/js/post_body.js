...
jQuery(document).ready(function() {
   ...
   jQuery('.dropdown-menu').find('form').click(function (e) {
    ...
    // Hide the alert after a short while...
    setTimeout(function()
    {
        $('.mainpanel > .contentpanel > .alert:first-child').slideUp();
    }, 10000);


    // Ask users for confirmation when clicking certain links...
    ...
    // Search tag filter...
    $('#search_tag_select').change(function()
    {

        var search_tags = $('#search_tag_select').val();
